{-# LINE 1 "Graphics/UI/SDL/Render.hsc" #-}

{-# LINE 2 "Graphics/UI/SDL/Render.hsc" #-}
...
blendModeToCInt BMNone = 0
{-# LINE 99 "Graphics/UI/SDL/Render.hsc" #-}
blendModeToCInt BMBlend = 1
{-# LINE 100 "Graphics/UI/SDL/Render.hsc" #-}
blendModeToCInt BMAdd = 2
{-# LINE 101 "Graphics/UI/SDL/Render.hsc" #-}
blendModeToCInt BMMod = 4
{-# LINE 102 "Graphics/UI/SDL/Render.hsc" #-}

cIntToBlendMode :: CInt -> BlendMode
cIntToBlendMode 0 = BMNone
{-# LINE 105 "Graphics/UI/SDL/Render.hsc" #-}
cIntToBlendMode 1 = BMBlend
{-# LINE 106 "Graphics/UI/SDL/Render.hsc" #-}
cIntToBlendMode 2 = BMAdd
{-# LINE 107 "Graphics/UI/SDL/Render.hsc" #-}
cIntToBlendMode 4 = BMMod
{-# LINE 108 "Graphics/UI/SDL/Render.hsc" #-}
...
flipToC :: Flip -> CInt
flipToC Horizontal = 1
{-# LINE 115 "Graphics/UI/SDL/Render.hsc" #-}
flipToC Vertical = 2
{-# LINE 116 "Graphics/UI/SDL/Render.hsc" #-}
...
foreign import ccall unsafe "SDL_CreateWindowAndRenderer"
  sdlCreateWindowAndRenderer
    :: Int32 -> Int32 -> Word32
{-# LINE 171 "Graphics/UI/SDL/Render.hsc" #-}
    -> Ptr (Ptr WindowStruct) -> Ptr (Ptr RendererStruct) -> IO ( Int32 )
{-# LINE 172 "Graphics/UI/SDL/Render.hsc" #-}
